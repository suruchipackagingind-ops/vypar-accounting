import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, o, i as invariant, u as useNavigate, j as jsxRuntimeExports, B as Button, I as InvoiceType } from "./index-9WJHbuJb.js";
import { u as useDashboard, f as formatINRCompact, S as Skeleton, a as useMonthlyCashFlow, b as formatINR, c as useAgingReport, d as useInvoices, e as useParties, g as formatDate } from "./types-DrzT-PkP.js";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-muted-foreground uppercase tracking-wide", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-3.5 h-3.5 ${colorClass}` })
        ] }),
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-28 mt-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-16" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-[10px] bg-destructive/10 text-destructive rounded px-1.5 py-0.5 font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-2.5 h-2.5" }),
          badge
        ] }) }),
        sub && !badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground mt-1", children: sub })
      ]
    }
  );
}
function CashFlowChart() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-b border-border flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[11px] font-semibold text-foreground uppercase tracking-wide", children: "Monthly Cash Flow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-3 text-[10px] text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-sm bg-[oklch(0.65_0.2_145)]" }),
              "Inflow"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-sm bg-[oklch(0.6_0.18_25)]" }),
              "Outflow"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-36 w-full" }) : chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "h-36 flex items-center justify-center",
            "data-ocid": "dashboard.cashflow.empty_state",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "No cash flow data yet" })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 148, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, barGap: 2, barSize: 10, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            YAxis,
            {
              ...
              axisLine: false,
              tickLine: false,
              tickFormatter: (v2) => formatINRCompact(v2),
              width: 48
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function AgingTable({
  ...
  const b0 = buckets == null ? void 0 : buckets.find((b2) => b2.bucket === "0-30");
  const b30 = buckets == null ? void 0 : buckets.find((b2) => b2.bucket === "30-60");
  const b60 = buckets == null ? void 0 : buckets.find((b2) => b2.bucket === "60+");
  const total = ((b0 == null ? void 0 : b0.totalAmount) ?? 0) + ((b30 == null ? void 0 : b30.totalAmount) ?? 0) + ((b60 == null ? void 0 : b60.totalAmount) ?? 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded", "data-ocid": ocid, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[11px] font-semibold text-foreground uppercase tracking-wide", children: title }) }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-left text-[10px] font-medium text-muted-foreground", children: "Age" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-right text-[10px] font-medium text-muted-foreground", children: "Count" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-right text-[10px] font-medium text-muted-foreground", children: "Amount" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        ...
        ].map(({ label, data, warnClass }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border/50 hover:bg-muted/30",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-[11px] text-muted-foreground", children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "td",
                {
                  className: `px-3 py-1.5 text-right font-mono text-[11px] ${warnClass}`,
                  children: data ? Number(data.count) : 0
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "td",
                {
                  ...
                  children: formatINR((data == null ? void 0 : data.totalAmount) ?? 0)
                }
              )
            ]
          },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-[11px] font-semibold text-foreground", children: "Total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-right font-mono text-[11px] font-semibold text-foreground", children: buckets ? buckets.reduce((s2, b2) => s2 + Number(b2.count), 0) : 0 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-right font-mono text-[11px] font-semibold text-foreground", children: formatINR(total) })
        ] })
      ] })
    ] })
  ] });
...
function RecentInvoices() {
  ...
  const partyMap = new Map(parties.map((p2) => [String(p2.id), p2]));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-b border-border flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[11px] font-semibold text-foreground uppercase tracking-wide", children: "Recent Invoices" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-full" }, i)) }) : recent.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "px-3 py-6 flex flex-col items-center justify-center",
            "data-ocid": "dashboard.recent_invoices.empty_state",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "No invoices yet. Create your first invoice." })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-left text-[10px] font-medium text-muted-foreground", children: "Invoice #" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-left text-[10px] font-medium text-muted-foreground", children: "Party" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-left text-[10px] font-medium text-muted-foreground", children: "Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-right text-[10px] font-medium text-muted-foreground", children: "Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 text-right text-[10px] font-medium text-muted-foreground", children: "Status" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: recent.map((inv, idx) => {
            var _a;
            const statusKey = typeof inv.status === "object" ? Object.keys(inv.status)[0] : String(inv.status);
            const partyName = ((_a = partyMap.get(String(inv.partyId))) == null ? void 0 : _a.name) ?? String(inv.partyId);
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                tabIndex: 0,
                ...
                onClick: () => navigate({ to: "/invoices" }),
                onKeyDown: (e3) => e3.key === "Enter" && navigate({ to: "/invoices" }),
                "data-ocid": `dashboard.recent_invoices.item.${idx + 1}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 font-mono text-[11px] text-primary", children: inv.invoiceNumber }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-[11px] text-foreground max-w-[120px] truncate", children: partyName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-[11px] text-muted-foreground", children: formatDate(inv.createdAt) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-right font-mono text-[11px] font-medium text-foreground", children: formatINR(inv.grandTotal) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-1.5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InvoiceStatusBadge, { status: statusKey }) })
                ]
              },
              String(inv.id)
            );
...
function DashboardPage() {
  ...
  const navigate = useNavigate();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-3", "data-ocid": "dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold text-foreground", children: "Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: (/* @__PURE__ */ new Date()).toLocaleDateString("en-IN", {
          weekday: "short",
          day: "2-digit",
          month: "short",
          year: "numeric"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          label: "Total Sales",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Receivables",
          value: summary ? formatINRCompact(summary.outstandingReceivables) : "—",
          colorClass: "text-[oklch(0.6_0.16_50)]",
          borderColorClass: "border-l-[oklch(0.65_0.2_50)]",
          icon: IndianRupee,
          loading: isLoading,
          badge: summary && Number(summary.overdueInvoicesCount) > 0 ? `${Number(summary.overdueInvoicesCount)} overdue` : void 0
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CashFlowChart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        AgingTable,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RecentInvoices, {})
  ] });
}
export {
